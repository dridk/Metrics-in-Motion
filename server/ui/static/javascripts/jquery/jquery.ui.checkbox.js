...
(function ($) {
    ...
    $.widget("ui.checkbox", {
        _create: function () {
            ...
            this.boxElement = $("<div class='ui-checkbox-box ui-widget ui-state-active ui-corner-all'><span class='ui-widget-checkbox-icon'></span></div>");
        ...
        _setOption: function (key, value) {
            if (key === "disabled") {
                this.element
                    .attr("disabled", value);
                this.checkboxElement[value ? "addClass" : "removeClass"]("ui-checkbox-disabled");
            }
