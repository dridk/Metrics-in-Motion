...
//        };
        ...
        var _uiSetupChart = function(data, el) {
            ...
            var dom = el.get();
            var spec = data.spec;
            //spec.data[0].name = "table"+data.sourceID; This var has to stay with the spec because the whole code relies on it.
            //TODO have this URLS generated by system when USER module is figured out
            spec.data[0].url = "/users/32/sources/"+data.sourceID+"/data";
            //---
